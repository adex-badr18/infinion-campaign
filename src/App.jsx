...
import Campaigns, { loader as campaignsLoader } from "./pages/campaigns/Campaigns";
...
import CampaignView, {loader as campaignViewLoader} from "./pages/campaign/campaignView/CampaignView";
...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: "campaigns/:id", element: <CampaignView />, loader: campaignViewLoader },
